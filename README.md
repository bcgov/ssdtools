...
`ssdca` is an R package to fit Species Sensitivity Distributions using
Maximum Likelihood and plot the data and results.

This package is under development for the B.C. Ministry of Environment
by [Poisson Consulting](https://github.com/poissonconsulting).
