...
test_that("hp fitdist cis", {
  ...
  expect_equal(as.data.frame(ssd_hp(boron_lnorm, 1, ci = TRUE, nboot = 10)), structure(list(conc = 1, est = 1.95430302556699, se = 1.35685517597222, 
    lcl = 0.752600358938875, ucl = 4.40350933171247, dist = "lnorm"), class = "data.frame", row.names = c(NA, 
-1L)))
...
), dist = rep("lnorm", 2)), class = "data.frame", row.names = c(NA, -2L)))
})
...
NA_real_, NA_real_, NA_real_), dist = rep("average", 4)), class = "data.frame", row.names = c(NA, 
-4L)))
})
...
test_that("hp fitdists cis", {
  ...
  expect_equal(as.data.frame(ssd_hp(boron_dists, 1, ci = TRUE, nboot = 10)), structure(list(conc = 1, est = 3.6651119524728, se = 2.47335604452443, 
    lcl = 0.542279934470833, ucl = 7.19977242012522, dist = "average"), class = "data.frame", row.names = c(NA, 
-1L)))
...
7.19977242012522, 82.2246167336774, 100), dist = rep("average", 4)), class = "data.frame", row.names = c(NA, 
-4L)))
})
...
NA_real_), lcl = c(NA_real_, NA_real_, NA_real_, NA_real_), ucl = c(NA_real_, 
NA_real_, NA_real_, NA_real_), dist = rep("lnorm", 4)), class = "data.frame", row.names = c(NA, 
-4L))
  )
})
