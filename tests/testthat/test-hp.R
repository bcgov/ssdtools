...
test_that("hp fitdists", {
  ...
  expect_identical(colnames(hp), c("dist", "conc", "est", "se", "lcl", "ucl"))
  expect_identical(hp$conc, 1)
  expect_equal(hp$est, 3.66685289601684)
  expect_equal(hp$se, NA_real_)
  expect_equal(hp$lcl, NA_real_)
  expect_equal(hp$ucl, NA_real_)
  expect_equal(hp$dist, "average")
  ...
  expect_equal(hp$est, c(0, 3.66685289601684, 72.901779294128, 100))
...
test_that("hp fitdists cis", {
  ...
  expect_identical(hp$conc, 1)
  expect_equal(hp$est, 3.66685289601684)
  expect_equal(hp$se, 1.74868751513615)
  expect_equal(hp$lcl, 1.504219774765)
  expect_equal(hp$ucl, 6.15380314466917)
  expect_equal(hp$dist, "average") 
  ...
  expect_identical(hp$conc, c(0, 1, 30, Inf))
  expect_equal(hp$est, c(0, 3.66685289601684, 72.901779294128, 100))
  expect_equal(hp$se, c(0, 1.74868751513615, 8.02368479187063, 0))
  expect_equal(hp$lcl, c(0, 1.504219774765, 60.9397035994657, 100))
  expect_equal(hp$ucl, c(0, 6.15380314466917, 83.0799283010595, 100))
  expect_equal(hp$dist, c("average",  "average", "average", "average"))
})
