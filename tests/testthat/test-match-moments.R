...
test_that("match_moments default", {
  ...
  expect_equal(pars, list(llogis = c(locationlog = 0.96875, scalelog = 0.525), gamma = c(shape = 1.4796875, 
...
test_that("match_moments all", {
  ...
  expect_equal(
    ...
    list(burrIII2 = c(lshape = 0.399359130859376, lscale = -0.602319335937502
                    ...
                    ), gompertz = c(llocation = -2.17702827453613, lshape = -1.12955560684204
                    ), lgumbel = c(llocation = 0.534375, lscale = 0.7625), llogis = c(locationlog = 0.96875, 
