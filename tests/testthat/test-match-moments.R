...
context("match-moments")

test_that("match_moments default", {
  set.seed(10)
  pars <- ssd_match_moments()
  expect_equal(pars, list(burrIII2 = c(lshape = 0.399359130859376, lscale = -0.602319335937502
), gamma = c(shape = 1.46063842773437, scale = 2.72195434570313
