...
-1L), class = "data.frame")
  ...
  expect_identical(colnames(dists), 
                   c("dist", "ad", "ks", "cvm", "aic", "aicc", "bic", "delta", "weight"))
  expect_identical(dists$dist, c("gamma", "gompertz", "lgumbel", "llogis", 
"lnorm", "weibull"))
  expect_equal(dists$ad, c(0.440080783302818, 0.602165187357315, 
...
0.0542672742561657))
  expect_equal(dists$aic, c(237.630318352347, 237.61115441186, 
