...
test_that("manual", {
  ...
  expect_equal(
    ...
    c(
      1.07373870642628, 1.29945366523807, 1.76891782851293, 1.56256632555312,
  ...
  expect_equal(
    ...
    structure(list(
      percent = 5, est = 1.25049782701963, se = 0.631766229432851,
      lcl = 0.775282589272772, ucl = 2.60353063438925, dist = "average"
    ), row.names = c(
      NA,
      -1L
    ), class = "data.frame")
  ...
  expect_equal(dists$ad, c(
    0.440080783302818, 0.602165187357315,
    0.828638954899656, 0.487268240754265, 0.507033548166948, 0.434627293919434
  ))
  expect_equal(dists$ks, c(
    0.11688217126248, 0.120189751040992, 0.158266487930008,
    0.0993097760964311, 0.106514303667428, 0.116975804418597
  ), cvm = c(
    0.0553642028346856,
