...
test_that("hc multi_ci all", {
  ...
  expect_equal(hc_multi$est, 1.25677449265554, tolerance = 1e-6)
  testthat::expect_snapshot({
    hc_multi
  })
})
...
test_that("hc multi_ci all multiple hcs", {
  ...
  expect_equal(hc_average$est, c(1.24151700389853, 2.37337471483992), tolerance = 1e-6)
  expect_equal(hc_multi$est, c(1.25677449265554, 2.38164905743083), tolerance = 1e-6)
  testthat::expect_snapshot({
    hc_multi
  })
})
