...
test_that("dburrIII3", {
  ...
  expect_equal(dburrIII3(c(31, 15, 32, 32, 642, 778,187, 12)),
                   c(0.0009765625, 0.00390625, 0.000918273645546373, 0.000918273645546373, 
2.41867799897932e-06, 1.64787810975198e-06, 2.82933454051607e-05, 
0.00591715976331361))
  expect_equal(dburrIII3(c(31, 15, 32, 32, 642, 778,187, 12), log = TRUE),
                   log(c(0.0009765625, 0.00390625, 0.000918273645546373, 0.000918273645546373, 
2.41867799897932e-06, 1.64787810975198e-06, 2.82933454051607e-05, 
0.00591715976331361)))
  ...
  expect_equal(coef(dist), c(lshape1 = 13.7306749122748, lshape2 = -0.148593002318655, lscale = 12.4107584491757))
  ...
  expect_true(is.fitdist(dist))
  expect_equal(coef(dist), c(lshape1 = 14.9250144484367, lshape2 = -0.148438502049071, lscale = 20.7011702445245))
})
...
test_that("pburrIII3", {
  ...
  expect_equal(pburrIII3(qburrIII3(c(.001, .01, .05, .50, .99))),
            c(.001, .01, .05, .50,.99))
})
...
test_that("rburrIII3", {
  ...
  set.seed(101)
  expect_equal(rburrIII3(10), 
               c(0.592859849849427, 0.0458334582732346, 2.44452273715775, 1.92133200433186, 
