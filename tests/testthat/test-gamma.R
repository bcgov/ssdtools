...
test_that("pgamma extremes", {
  ...
  expect_equal(pgamma(1, log.p = TRUE), log(0.632120558828558))
  expect_equal(pgamma(1, lower.tail = FALSE), 1 - 0.632120558828558)
  expect_equal(pgamma(1, lower.tail = FALSE, log.p = TRUE), log(1 - 0.632120558828558))
...
test_that("qgamma extremes", {
  ...
  expect_equal(qgamma(log(0.75), log.p = TRUE), 1.38629436111989)
