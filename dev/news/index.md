...
- Added column `"dists"` to
  [`ssd_hc()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hc.md),
  [`ssd_hp()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hp.md)
  and [`predict()`](https://rdrr.io/r/stats/predict.html) which is a
...
- [`ssd_hc()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hc.md),
  [`ssd_hp()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hp.md)
  and [`predict()`](https://rdrr.io/r/stats/predict.html) now only
  return missing values for `se`, `lcl` and `ucl` when `nboot = 0`.
...
- Modified
  ...
  and
  [`ssd_hp()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hp.md)
  so does not average if just one distribution.
...
[`ssd_hc()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hc.md)
and [`predict()`](https://rdrr.io/r/stats/predict.html) now includes a
...
- [`ssd_hp_bcanz()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hp_bcanz.md)
  and
  [`ssd_hp.fitburrlioz()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hp.md)
...
- `ssd_exx()` family of functions
  (i.e. [`ssd_elnorm()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_e.md),
...
- `save_to = NULL` to
  ...
  and
  [`ssd_hp()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hp.md)
  to specify a directory in which to save the bootstrap datasets as csv
...
- [`ssd_hc()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hc.md)
  and
  [`ssd_hp()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hp.md)
  now return data frame with `parametric` column.
- [`ssd_hp()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hp.md)
  now return data frame with `wt` column.
...
- `percent = 5` in
  [`ssd_hc()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hc.md)
  and [`predict()`](https://rdrr.io/r/stats/predict.html) was
...
[`ssd_hp()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hp.md).
By default confidence intervals are estimated by parametric
bootstrapping.
...
[`ssd_gof()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_gof.md)
to specify whether to return p-values for the test statistics as opposed
to the test statistics themselves.
...
- Changed implicit behaviour of
  [`ssd_hc()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hc.md)
  and [`predict()`](https://rdrr.io/r/stats/predict.html) where
  `ci = TRUE` to explicit `ssd_hc(ci = FALSE)` and
  `predict(ci = FALSE)`.
...
- Added
  [`ssd_hp()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_hp.md)
  to calculate hazard percent at specific concentrations.
- Added
