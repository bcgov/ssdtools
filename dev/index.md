...
The six default distributions are fit using
...
![A plot of the data and fitted
distributions](reference/figures/README-unnamed-chunk-4-1.png)
...
![A plot of the data and model-averaged prediction with confidence
intervals](reference/figures/README-unnamed-chunk-8-1.png)
...
- MAJOR versions – updates that result in changes to the way that water
  ...
  and the shinyssdtools application).
