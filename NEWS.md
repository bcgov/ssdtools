...
- AICc is now `Inf` when the number of observations is less than or equal to the number of parameters the small sample correction is undefined (poissonconsulting/ssdtools#175).
