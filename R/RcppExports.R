...
dburrIII3_ssd <- function(x, shape1, shape2, scale) {
    .Call('_ssdtools_dburrIII3_ssd', PACKAGE = 'ssdtools', x, shape1, shape2, scale)
}

pburrIII3_ssd <- function(q, shape1, shape2, scale) {
    .Call('_ssdtools_pburrIII3_ssd', PACKAGE = 'ssdtools', q, shape1, shape2, scale)
}

qburrIII3_ssd <- function(p, shape1, shape2, scale) {
    .Call('_ssdtools_qburrIII3_ssd', PACKAGE = 'ssdtools', p, shape1, shape2, scale)
}

rburrIII3_ssd <- function(n, shape1, shape2, scale) {
