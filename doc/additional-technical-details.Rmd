...
Let $X \sim Burr(b,c,k)$ have the *pdf* given in the box above. We make the transformation $Y = \frac{{b{\kern 1pt} {k^{\tfrac{1}{c}}}{\kern 1pt} \theta }}{X}$

where $\theta$ is a parameter (constant). The distribution of $Y$ is also a Burr distribution and has *cdf* ${G_Y}\left( y \right) = 1 - \frac{1}{{{{\left[ {1 + {{\left( {\frac{y}{{{k^{\tfrac{1}{c}}}{\kern 1pt} \theta }}} \right)}^c}} \right]}^k}}}$.
