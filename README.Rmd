...
The dependency [`ssddata`](https://cran.r-project.org/package=ssddata) provides example data sets for several chemicals including Boron.
```{r, message=FALSE}
library(ssdtools)
ssddata::ccme_boron
```
...
Get started with ssdtools at <https://bcgov.github.io/ssdtools/articles/ssdtools.html> and visit the [FAQ](https://bcgov.github.io/ssdtools/articles/faqs.html)s.
