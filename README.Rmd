...
To install the latest version development version and build its vignette:
...
For more information and examples of how to use `ssdtools` in conjuction with `fitdistrplus` to
