...
Species sensitivity distributions are cumulative probability distributions which are fitted to toxicity concentrations for multiple species.
...
Confidence intervals are produced by bootstrapping.
