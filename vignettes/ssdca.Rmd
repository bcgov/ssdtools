---
title: "Introduction to ssdtools"
author: "Joe Thorley"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
 %\VignetteIndexEntry{Introduction to ssdtools}
...
The `ssdtools` package fits and plots Species Sensitivity Distributions.
This vignette describes how to use `ssdtools` in conjunction with 
...
The actual fits can be plotted using the ggplot2 generic `autoplot`.
```{r, fig.width = 5 }
library(ggplot2)
