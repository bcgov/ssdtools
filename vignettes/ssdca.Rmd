...
The `sscda` package provides four ggplot geoms to allow you construct your own plots.
They are `geom_ssd()` to plot the data, `geom_fitdist()` to plot a model fit,  
...
To log the x-axis use `coord_trans()`.
```{r, fig.width = 5, fig.height = 4}
