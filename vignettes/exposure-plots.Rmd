...
The *ssdtools* package produces a plot of the cumulative distributions for multiple distribution through the use of the *autoplot()* function. 
...
fit.plot <- autoplot(fit) + scale_color_ssd()
