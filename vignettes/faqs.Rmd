...
Left censoring when only the upper bound is known, right censoring when only the lower bound is known
and interval censored when both the upper and lower bound are known.
...
- distribution fitting to left or interval censored data;
- model averaging when the distributions have the same number of parameters; and
