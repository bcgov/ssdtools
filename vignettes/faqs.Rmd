...
- probability density (`ddist(x, par1, par2, log = FALSE)`)
- cumulative distribution (`pdist(q, par1, par2, lower.tail = TRUE, log.p = FALSE)`)
- inverse cumulative distribution (`qdist(p, par1, par2, lower.tail = TRUE, log.p = FALSE)`)
- random samples (`rdist(n, par1, par2)`)
- starting values (`sdist(x)`)
