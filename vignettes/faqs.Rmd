...
```{r, alt.text = "A plot showing the model averaged fit and the individual fits for the ccme_boron data."}
library(ssdtools)
...
### How can I include mathematical expressions in the xlabel when using `ssd_plot()`?

```{r, message = FALSE, alt.text = "A plot showing the model averaged fit with a mathematical expression in the xlabel with the units."}
library(ssdtools)
