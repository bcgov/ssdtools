...
perhaps concern about bias in MLE is misplaced.
...
is `r round(REG.HC5/MLE.HC5,2)`x on the concentration scale.
...
is `r round(REG.HC1/MLE.HC1,2)`x on the concentrations scale
...
problems with small sample sizes including (a) most distributions will have adequate fits
and it is unlikely be possible to discriminate between distributions;
