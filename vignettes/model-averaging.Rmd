...
The method, as applied in the SSD context is described in detail in [@fox_recent_2021], and potentially provides a level of flexibility and parsimony that is difficult to achieve with a single SSD distribution".* &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; [@fox_methodologies_2021]
...
<br>Since most of the common SSD models are 2-parameter, we should be aiming to have a sample size of at least 11.
...
Sadly, this is rarely the case in practice! 
