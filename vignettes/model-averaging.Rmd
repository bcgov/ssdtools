...
$$AI{{C}_{c}}=AIC+\frac{2{{k}^{2}}+2k}{n-k-1}$$

where <i>n</i> is the sample size and <i>k</i> is the number of parameters.
...
<div style="text-align: center;"font-size: 1.2em; color:#3664EE;" class="box";><b><u>Sample size rule-of-thumb for SSD modelling</u></b> $$n\ge 5k+1$$
