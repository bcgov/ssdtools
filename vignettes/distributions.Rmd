...
The three distributions are plotted below with a mean of 1 and standard deviation of 1 on the log concentration scale.
```{r, message=FALSE}
library(ssdtools)
library(ggplot2)
...
For completeness the hazard concentrations for the other distributions provided by `ssdtools` are plotted below with a mean of 1 and standard deviation of 1 on the log concentration scale.
```{r,fig.height=5}
set.seed(7)
ssd_plot_cdf(ssd_match_moments(dists = c("burrIII2", "burrIII3", "gamma",
