...
<div style="text-align: center; font-size: 1.2em; color: #3664EE; border: 1px solid #3664EE; padding: 10px; border-radius: 5px;">
...
$${{f_X}\left( {x;\eta ,b} \right) = b{\kern 1pt} \eta \exp \left( {\eta  + bx - \eta {e^{bx}}} \right)} ; \quad 0 \le x < \infty ,\eta ,b > 0\\$$


$${{F_X}\left( {x;\eta ,b} \right) = 1 - \exp \left[ { - \eta \left( {{e^{bx}} - 1} \right)} \right]} ; \quad 0 \le x < \infty ,\eta ,b > 0$$
...
$${{f_X}\left( {x;\alpha ,\beta } \right) = \alpha {\kern 1pt} {\beta ^\alpha }{\kern 1pt} {x^{ - \left( {\alpha  + 1} \right)}}} ; \quad x > \beta ;\;\alpha ,\beta  > 0\\$$
...
$${{g_Y}\left( {y;\alpha ,\beta } \right) = \alpha {\kern 1pt} {\beta ^\alpha }{\kern 1pt} {y^{\alpha  - 1}}} ;\quad y \le \frac{1}{\beta };\;\;\alpha ,\beta  > 0\\$$
