...
When calculating the model-averaged estimates treating the distributions as constituting a single mixture distribution ensures that `ssd_hc()` is the inverse of `ssd_hp()`, and this applies for model-averaged CIs.
